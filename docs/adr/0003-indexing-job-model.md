...
When `LIGHTRAG_ENABLED=true`, admin upload forwarding is delegated to the remote LightRAG service and the local response may have no local indexing `job_id`.
