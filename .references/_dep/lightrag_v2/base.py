...
class QueryParam:
    ...
    enable_parent_context: bool = _env_bool("ENABLE_PARENT_CONTEXT", "true")
    """If True, expands retrieved structural chunks with nearby document-graph context."""

    parent_context_window: int = int(os.getenv("PARENT_CONTEXT_WINDOW", "1"))
    """Number of previous/next blocks to include for small-to-big retrieval expansion."""

    include_parent_section: bool = _env_bool("INCLUDE_PARENT_SECTION", "true")
    """If True, include parent section metadata in small-to-big retrieval expansion."""
