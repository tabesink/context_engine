...
- Swagger UI: http://localhost:9650/docs
- ReDoc: http://localhost:9650/redoc
...
```bash
curl -X POST "http://localhost:9650/query" \
...
```bash
curl -X POST "http://localhost:9650/query/stream" \
    -H "Content-Type: application/json" \
    -d '{"query": "Your question here", "mode": "hybrid"}'
```
...
```bash
curl -X POST "http://localhost:9650/documents/text" \
    -H "Content-Type: application/json" \
...
```bash
curl -X POST "http://localhost:9650/documents/file" \
...
```bash
curl -X POST "http://localhost:9650/documents/batch" \
...
```bash
curl -X POST "http://localhost:9650/documents/scan" --max-time 1800
```
...
```bash
curl -X DELETE "http://localhost:9650/documents"
```
...
```bash
curl http://localhost:9650/api/version
```
...
```bash
curl http://localhost:9650/api/tags
```
...
```shell
curl -N -X POST http://localhost:9650/api/chat -H "Content-Type: application/json" -d \
