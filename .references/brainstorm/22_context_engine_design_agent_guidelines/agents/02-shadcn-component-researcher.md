...
Read the requirements file and inspect the current app component inventory. Use the shadcn MCP/registry tools to identify suitable components or blocks. Produce a research document with:
